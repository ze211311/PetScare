...
const { UpdatePet, getAPet, getStatus, regPet, getVac, getApp, getAVet, getAVeripet } = require('./modules/pet.js')
...
app.get('/user/getAVet', getAVet)

app.get('/user/getAVeripet', getAVeripet)
